                ...
                <div class="card text-center">
                    <div class="card-content">
                        <div class="card-body py-1">
                            <label for="">Every minute</label>
                            <input type="text" value="curl -s {{url('interest')}}" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card text-center">
                    <div class="card-content">
                        <div class="card-body py-1">
                            ...
                            <h3 class="mb-0">{{\App\Models\Withdrawal::where('status', 'approved')->sum('amount')}}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card text-center">
                    <div class="card-content">
                        <div class="card-body py-1">
                            ...
                            <h3 class="mb-0">{{\App\Models\Deposit::where('status', 'approved')->sum('amount')}}</h3>
                        </div>
                    </div>
                </div>
            </div>
